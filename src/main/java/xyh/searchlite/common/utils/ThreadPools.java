...
public class ThreadPools {
    ...
    private ExecutorService articlePool;



    private ThreadPools() {
        articlePool = new ThreadPoolExecutor(
                2
                , 16
                , 15
                , TimeUnit.MINUTES
                , new ArrayBlockingQueue<Runnable>(1024)
                , new NamedThreadFactory("article"));
     ...
     * @param task
     */
    public void submitArticleTask(Runnable task) throws RejectedExecutionException {
       articlePool.submit(task);
    }



    public void shutdown() {
        articlePool.shutdown();
    }
